...
import com.issac.util.JsonUtil;
import com.issac.util.MathUtil;
...
public class PayServiceImpl implements PayService {
    ...
    public PayResponse notify(String notifyData) {
        ...
        if (!MathUtil.equals(orderDTO.getOrderAmount().doubleValue(), payResponse.getOrderAmount())) {
            log.error("【微信支付】异步通知，订单金额不一致，订单id={},微信通知金额={}，系统金额={}",
                    payResponse.getOrderId(), payResponse.getOrderAmount(), orderDTO.getOrderAmount());
            throw new SellException(ResultEnum.WX_NOTIFY_MONEY_VEIRY_ERROR);
        }
